	...
	<nav class="navbar navbar-inverse">
	  <div class="container-fluid">
	    <div class="navbar-header">
	      <a class="navbar-brand" href="Home.html">The Gaming Insider</a>
	    </div>
	    <ul class="nav navbar-nav">
	      <li><a href="Home.php">Home</a></li>
	      <li><a href="Games.php">Games</a>
	      <li class="active"><a href="Reviews.php">Review</a></li>
...
<?php
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
		if (isset($_POST["name dari tombol button"]))  {

			mysqli_query($conn, "DELETE FROM tabel-reviewnya WHERE card_id = $id");
